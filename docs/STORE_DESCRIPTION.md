# Chrome Web Store Metni

Bu dosya mağaza formuna kopyalanacak kısa metinleri içerir. Teknik dokümantasyon değildir.

## Türkçe

### Kısa açıklama

Instagram’da geri takip etmeyenleri bulun; filtreler, dry-run, undo ve güvenli gecikmelerle yönetin.

### Açıklama

Instagram Unfollow Radar, tarayıcıdaki mevcut Instagram oturumunuzu kullanarak takipçi ve takip edilen listelerini karşılaştırır. Geri takip etmeyen hesapları belirler ve isterseniz otomatik olarak takipten çıkarır.
...
Find Instagram non-followers with filters, dry-run, undo, randomized delays, and local processing.

### Description

Instagram Unfollow Radar compares followers and following lists through your existing Instagram browser session. It identifies non-followers and can automatically unfollow them.
